        ...
        <div className={`w-[353px] h-[83px] rounded-xl px-4 ${m["progress-element"]} grid grid-cols-2 flex items-center flex items-center`}>
            <div className="flex">
                <div className="relative w-[60px] h-[60px]">
                    <Progress type="circle" strokeColor={progressColor} percent={calculatorPercent(activeData)} format={(percent) => <span className="text-black text-sm">{percent}%</span>} size={60} />
                    <Progress type="circle" percent={calculatorPercent(inActiveData)} size={50} strokeColor="#7E7D88" className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" format={() => ""} />
                </div>
            ...
            <div className="grid grid-cols-1 gap-[5px]">
                <div className="flex items-center">
                    ...
                    <div className="flex justify-between items-center grow">
                        ...
                        <div className={`text-[${progressColor}] font-bold text-sm leading-[18px]`}>{activeData}</div>
                    </div>
                </div>
                <div className="flex items-center">
                    ...
                    <div className="flex justify-between items-center grow">
                        ...
                        <div className={`text-[${progressColor}] font-bold text-sm leading-[18px]`}>{inActiveData}</div>
                    </div>
                </div>
            </div>
        </div>
